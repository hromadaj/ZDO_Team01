...
#Funkce pro hledani uhlu a pruseciku a zaroven tako vzkresleni
def process(rezy,stehy,img_og,image_filename,visualize):
  ...
  if visualize == True:
    ...
    fig.savefig('processed_'+image_filename)
...
##############################################################
#Hlavni funkce
#Vstupem je obrazek v sedotonu, puvodni obrazek a informace jestli ma probehnout vizualizace
...
#kontrola zdali se ma vykreslovat ci nikoliv
if sys.argv[2] == "-v":
    for i in range(3,len(sys.argv)):
        ...
        #Kontroloa jestli je obrazek natocen spravne
